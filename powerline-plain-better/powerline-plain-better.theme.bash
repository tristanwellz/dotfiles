...
CWD_THEME_PROMPT_DATE_COLOR=125
...
function __powerline_clock_prompt {
  CLOCK_THEME_PROMPT="$(set_rgb_color - ${CWD_THEME_PROMPT_DATE_COLOR})$(date +"${THEME_PROMPT_CLOCK_FORMAT}")${CLOCK_THEME_PROMPT_COLOR}"
}
...
function powerline_prompt_command() {
    ...
    PS1="${CLOCK_THEME_PROMPT}${SHELL_PROMPT}${VIRTUALENV_PROMPT}${SCM_PROMPT}${CWD_PROMPT}${LAST_STATUS_PROMPT}\n${reset_color}→ "
}
